    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        <div className="relative flex-1 max-w-md">
          ...
          <input
            type="text"
            placeholder={`Search ${CONTENT_TYPES[activeType]?.label?.toLowerCase() || 'items'}...`}
            value={searchTerm}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-medium" style={{ color: '#ffffff' }}>
              Available {CONTENT_TYPES[activeType]?.label || 'Items'}
            </h3>
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-medium" style={{ color: '#ffffff' }}>
              Assigned {CONTENT_TYPES[activeType]?.label || 'Items'}
            </h3>
