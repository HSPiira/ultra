...
class ServiceAdmin(admin.ModelAdmin):
    list_display = ("name", "category", "service_type", "base_amount", "status", "created_at")
...
class MedicineAdmin(admin.ModelAdmin):
    list_display = ("name", "dosage_form", "route", "unit_price", "status", "created_at")
...
class HospitalItemPriceAdmin(admin.ModelAdmin):
    list_display = ("hospital", "content_type", "object_id", "amount", "available", "status", "created_at")
