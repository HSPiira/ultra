...
class HospitalService:
    @staticmethod
    def create(*, hospital_data: Dict, user=None) -> Hospital:
        return Hospital.objects.create(**hospital_data)

    @staticmethod
    def update(*, hospital_id: str, update_data: Dict, user=None) -> Hospital:
    ...
    @staticmethod
    def deactivate(*, hospital_id: str, user=None) -> None:
        hospital = Hospital.objects.get(pk=hospital_id)
