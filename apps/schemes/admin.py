...
class SchemeAdmin(admin.ModelAdmin):
    list_display = ('id', 'scheme_name', 'company', 'card_code', 'start_date', 'end_date', 'status', 'created_at')
...
class SchemeItemAdmin(admin.ModelAdmin):
    list_display = ('id', 'scheme', 'content_type', 'object_id', 'item', 'status', 'created_at')
